...
This is a bundle of all the files in the project directory, including subdirectories.

Used for AI language model input.

AI bot output should also conform to this format.
## Cargo.toml
```toml
[package]
name = "sheafy"
...
pathdiff = "0.2"
lazy_static = "1.4"
ignore = "0.4" # Add the ignore crate
